...
KNOWN_PREFIXES = {"de", "dela", "delos", "del", "san", "santa", "sto", "santo", "sta", "mac", "mc", "la", "los", "las", "vda", "da", "dos", "st", "al", "van", "von"}
KNOWN_SUFFIXES = {"jr", "sr", "snr", "ii", "iii", "iv", "v", "vi", "vii", "viii", "ix", "x"}
KNOWN_PROFESSIONAL_SUFFIXES = {"cpa", "md", "rn", "phd", "esq"}
