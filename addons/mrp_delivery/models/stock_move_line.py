...
class StockMoveLine(models.Model):
    ...
    def _compute_sale_price(self):
        ...
        for sol in kit_lines.move_id.sale_line_id:
            ...
            sale_line_exploded_list_price[sol] = sum(bom_line.uom_id._compute_quantity(data['qty'], bom_line.product_id.uom_id) * bom_line.product_id.list_price for bom_line, data in bom_lines)
