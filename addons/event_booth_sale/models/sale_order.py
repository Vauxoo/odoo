    ...
    def action_confirm(self):
        ...
        for so in self:
            ...
            if so_lines_missing_booth:
                ...
                raise ValidationError(self.env._("Please make sure all your event-booth related lines are configured before confirming this order:%s", so_lines_descriptions))
