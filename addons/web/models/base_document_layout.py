...
class BaseDocumentLayout(models.TransientModel):
    ...
    report_footer = fields.Html(related='company_id.report_footer', readonly=False, default=lambda self: self._default_report_footer())
    company_details = fields.Html(related='company_id.company_details', readonly=False, default=lambda self: self._default_company_details())
