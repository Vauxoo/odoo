...
class AccountCashRounding(models.Model):
    ...
    company_id = fields.Many2one('res.company', required=True, readonly=True, default=lambda self: self.env.company, ondelete='cascade')
    ...
    rounding_method = fields.Selection(required=True,
