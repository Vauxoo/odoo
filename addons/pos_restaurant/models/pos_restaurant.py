...
class RestaurantFloor(models.Model):
    ...
    floor_plan_layout = fields.Json(copy=False)
...
class RestaurantTable(models.Model):
    ...
    table_number = fields.Integer(required=True, help='The number of the table as displayed on the floor plan', default=0)
    seats = fields.Integer(default=1, help="The default number of customer served at this table.")
    ...
    parent_side = fields.Selection(selection=[('left', 'Left'), ('right', 'Right'), ('top', 'Top'), ('bottom', 'Bottom')], help="The parent table side where this table will be displayed")
    active = fields.Boolean(default=True, help='If false, the table is deactivated and will not be available in the point of sale')
    floor_plan_layout = fields.Json()
