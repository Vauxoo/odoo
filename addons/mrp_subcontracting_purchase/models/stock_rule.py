    ...
    def _get_lead_days(self, product, bypass_delay_description=False, **values):
        ...
        if seller.delay >= bom.produce_delay + bom.days_to_prepare_mo:
            ...
            if not bypass_delay_description:
                delay_description.append((self.env._('Receipt Date'), int(seller.delay)))
                delay_description.append((self.env._('Vendor Lead Time'), self.env._('+ %d day(s)', seller.delay)))
        else:
            ...
            if not bypass_delay_description:
                delay_description.append((self.env._('Receipt Date'), manufacture_delay))
