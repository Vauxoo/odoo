    ...
    def _prepare_lead_qualification_template_values(self):
        return {
            ...
            'question_and_page_ids': [
                (0, 0, {  # survey.question
                    'title': self.env._('Let\'s start with a basic question. What\'s your email address?'),
                ...
                (0, 0, {  # survey.question
                    'title': self.env._('Which of the following best describes your main goal?'),
                    'question_type': 'simple_choice',
                    'constr_mandatory': True,
                    'suggested_answer_ids': [
                        (0, 0, {  # survey.question.answer
                ...
                (0, 0, {  # survey.question
                    'title': self.env._('Who will make the final decision on this purchase?'),
                    'question_type': 'simple_choice',
                    'constr_mandatory': True,
                    'suggested_answer_ids': [
                        (0, 0, {  # survey.question.answer
