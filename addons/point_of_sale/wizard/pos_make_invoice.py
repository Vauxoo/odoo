...
class PosMakeInvoice(models.TransientModel):
    ...
    def action_create_invoices(self):
        ...
        if not selected_orders:
            raise UserError(self.env._("No valid orders were selected. No new invoices could be generated"))

        is_single_order = len(selected_orders) == 1

        invalid_refund_orders = selected_orders.filtered(lambda o: o.refunded_order_id.is_singly_invoiced)
