    ...
    def _check_session_state(self):
        ...
        if open_session:
            raise ValidationError(
                self.env._("You are not allowed to change the rounding configuration while a pos session using it is already opened. Make sure to close all open pos session before proceeding."))
