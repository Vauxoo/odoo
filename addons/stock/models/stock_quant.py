...
class StockQuant(models.Model):
    ...
    product_id = fields.Many2one(
        'product.product', domain=lambda self: self._domain_product_id(),
    ...
    location_id = fields.Many2one(
        'stock.location', domain=lambda self: self._domain_location_id(),
    ...
    package_id = fields.Many2one(
        'stock.package', domain="['|', ('location_id', '=', location_id), '&', ('location_id', '=', False), ('quant_ids', '=', False)]",
        help='The package containing this quant', ondelete='restrict', check_company=True, index=True)
    owner_id = fields.Many2one(
        'res.partner', help='This is the owner of the quant', check_company=True,
    ...
    on_hand = fields.Boolean(store=False, search='_search_on_hand')
    ...
    def get_import_templates(self):
        return [{
            'label': self.env._('Template for Inventory Adjustments'),
