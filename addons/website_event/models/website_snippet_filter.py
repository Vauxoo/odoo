    ...
    def _get_hardcoded_sample(self, model):
        ...
        if model._name == 'event.event':
            data = [{
                ...
                'name': self.env._('Great Reno Ballon Race'),
                ...
                'name': self.env._('Conference For Architects'),
                ...
                'name': self.env._('Live Music Festival'),
                ...
                'name': self.env._('Hockey Tournament'),
                ...
                'name': self.env._('OpenWood Collection Online Reveal'),
                ...
                'name': self.env._('Business Workshops'),
