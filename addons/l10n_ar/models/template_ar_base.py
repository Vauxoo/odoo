    ...
    def _get_ar_base_res_company(self):
        return {
            self.env.company.id: {
                ...
                'account_discount_expense_allocation_id': 'base_gastos_varios_comerciales',
                'account_discount_income_allocation_id': 'base_descuentos_obtenidos',
                'deferred_expense_account_id': 'base_gastos_pagados_por_adelantado',
                'deferred_revenue_account_id': 'base_ingresos_diferidos',
                ...
                'downpayment_account_id': 'base_anticipos_de_clientes',
                'display_invoice_tax_company_currency': False,
                'account_stock_valuation_id': 'base_mercaderia_reventa',
                'account_production_wip_account_id': 'base_productos_en_proceso',
                'account_production_wip_overhead_account_id': 'base_gastos_varios_produccion',
            },
        }
