...
class MailTemplatePreview(models.TransientModel):
    ...
    scheduled_date = fields.Char(compute='_compute_mail_template_fields',
    ...
    recipient_names = fields.Char(compute='_compute_mail_template_fields',
                                help="Names of the recipients")
    recipient_cc_names = fields.Char(compute='_compute_mail_template_fields',
