...
class MailMessage(models.Model):
    ...
    * snailmail.letter (snailmail addon)
    ...
    subtype_id = fields.Many2one('mail.message.subtype', ondelete='set null', index=True)
    mail_activity_type_id = fields.Many2one(
        'mail.activity.type', index='btree_not_null', ondelete='set null')
    ...
    author_id = fields.Many2one(
        'res.partner', index=True, ondelete='set null',
